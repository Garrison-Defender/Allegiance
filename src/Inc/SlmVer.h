...
#define rel     1040063.00       // mmf added to designate release number for a given build

#define rup		221115  // mmf make sure this has 6 digits otherwise version number conversion for esc display may fail,
